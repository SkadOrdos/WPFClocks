...
namespace WClocks
{
    ...
    public class Serializer
    {
        ...
        {
            string appDirectory = Path.GetDirectoryName(fileName);
            if (!String.IsNullOrEmpty(appDirectory) && !Directory.Exists(appDirectory)) Directory.CreateDirectory(appDirectory);
